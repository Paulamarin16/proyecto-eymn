...
<body>
    ...
    <h1 class="text-center p-3">Historial de registro de los servicios</h1>
    <?php 
    ...
    <div class="container-fluid row">
        <form class="col-4 p-3" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="my-input" class="form-label">Imagen (Mismo nombre del servicio)</label>
                ...
                <tbody>
                    ...
                    while ($datos= $sql->fetch_object()) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="modificar_servicio.php?ID_S=<?= $datos->ID_S ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a onclick="return eliminar()" href="crud_servicios.php?ID_S=<?= $datos->ID_S ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php  }
                    ?> 
