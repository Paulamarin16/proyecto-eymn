...
$sql = $con->prepare("SELECT ID_S, Nombre, Precio, Descuento, Tipo, Imagen FROM servicios WHERE activo=1 AND id_categoria=11");
$sql->execute();
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarHeader"> 
        <ul class="navbar-nav me-auto me-2 mb-lg-0">
          <li class="nav-item">
            <a href="../php/servicios.php" class="nav-link active"> Inicio </a>
          </li> 
        </ul> 
            ...
            <div class="card shadow-sm bs-card-height">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between aling-items-center"> 
                    <div class="btn-group">
                      <a href="detallesS.php?ID_S=<?php echo $row['ID_S']; ?>&token=<?php echo
                      hash_hmac('sha1', $row['ID_S'], KEY_TOKEN); ?>" class="btn btn-primary"> Detalles</a>
                    
                    </div>
                    <button class="btn btn-outline-primary" type="button" onclick="addProducto(<?php echo $row['ID_S']; ?>,
                    '<?php echo hash_hmac('sha1', $row['ID_S'], KEY_TOKEN); ?>')">Agregar al carrito</button>
                </div>
              </div>
            </div>
          </div>
...
<script>
      function addProducto(ID_S, token){
        let url= 'carritoS.php'
