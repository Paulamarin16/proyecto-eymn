...
<body>
            ...
            <div class="row">
              ...
              <div class="col-sm-4 offset-md-1 py-4">
                ...
                <ul class="list-unstyled">
                    <li><a href="../php/paginadeinicio.php" class="text-black">Productos</a></li>
    ...
    <div class="navegar2">
            ...
            <div class="back-menu" id="back-m"></div>
                <center><H1 class= "tituloS"> SERVICIOS </H1></center>
            </div>
            <div class="navegar2">
            <div class="btn_menu">
                <i class="fas fa-bars" id="btn_menu"></i>
            ...
            <nav id="menu">
                ...
                <img src="../img/imgpag/LOGO SIN FONDO.png" alt="">
                    ...
                    <ul> 
                        <li> <a href="../php/informatica.php"><img src="../img/informatica.jpg"><p><br>Informatica</p></a> </li> 
                        <li> <a href="../php/plomeria.php"><img src="../img/Plomeria.jpg"><p><br>Plomeria</p></a> </li>
                        <li> <a href="../php/arquitectura.php"><img src="../img/Arquitectura.jpg"><p><br>Arquitectura</p></a> </li>
                        <li> <a href="../php/mecanica.php"><img src="../img/Mecanica.jpg"><p><br>Mecanica</p></a> </li>
                    </ul>
            </nav>
        </div>
